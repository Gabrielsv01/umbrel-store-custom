...
import type { CustomToolDefinition, CustomToolMethod, SharedVolumeAccess } from '../types/customTools';
...
export default function CustomToolsCreator() {
  ...
  const isFormValid =
    ...
    (hasCustomMethods || hasSharedVolume);
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-8">
      ...
      {definition.name.trim() && !hasCustomMethods && !hasSharedVolume && (
        <div className="mt-6 rounded-lg border border-yellow-700 bg-yellow-900/30 p-3">
          <p className="text-sm text-yellow-300">
            ⚠️ Add custom methods or configure shared volume access
          </p>
        </div>
      )}
