...
export default function VolumesModal({
  ...
  const filteredVolumes = useMemo(() => {
    ...
    return volumes.filter((volume) => {
      const haystack =
        `${volume.name} ${volume.driver} ${volume.mountpoint || ''}`.toLowerCase();
        ...
        <div className="flex items-center justify-between border-b border-gray-800 px-6 py-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-gray-400">
              Review installed volumes and remove old ones not in use.
            </p>
          </div>
        ...
        <div className="overflow-auto p-4">
          <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <p className="text-xs text-gray-400">
              Showing {filteredVolumes.length} of {volumes.length}
            </p>
          </div>
                    ...
                    <tr key={volume.name}>
                      ...
                      <td className="px-3 py-2 text-right space-x-2 flex justify-end">
                        ...
                        <button
                          ...
                          disabled={
                            volume.inUse || removingName === volume.name
                          }
